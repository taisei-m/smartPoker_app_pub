<template>
  <v-ons-page>
    <div class="gradation">
      <h1 align="center" style="color:white; padding-top: 60px; padding-bottom: 20px">SmartPoker</h1>
      ...
      <v-ons-card style="margin-top:-20px">
        <div class="flex_box2">
          <div class="imgtable-content">
            <img class="i" src="./images/pokertable2.png" style="width:100%">
          <div v-for="(item,i) of players" v-bind:key="item.name">
            <div style="background-color: rgba(0,0,0,0.8);color:white;padding:8px; width: 17%; height: 12%; font-size: 63%;" v-bind:class="tableplayer[i]" v-bind:style="[players[i].name === turn? tableLightup:''] " v-bind:key="item.name">
